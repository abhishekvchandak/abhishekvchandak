...
{ 
	...
	if ($response != null && $response->success) {
		...
		$mail->Body    = 'Name: '.$name1 .'<br>Email: '.$email1.'<br>Number: '.$number1.'<br>Type: '.$type1.'<br>Special Instruction: '.$special1.'<br>Delivery Charge: '.$delivery_charge.'<br>Source: '.$address1.'<br>Destination: '.$address2.'<br>Weight: '.$weight_ceil;
		...
		$weight_ceil = str_replace(' ', '_', $weight_ceil);
...
if(isset($_POST['c_message']) && !empty($_POST['c_email']) && !empty($_POST['c_message'])){
...
//$mail->From = 'fakhriwild@gmail.com';
//$mail->FromName = 'Something';
$mail->SetFrom('care@simplydelivered.in', 'Response From Website'); // FROM
//$mail->AddAddress('josh@example.net', 'Josh Adams');  // Add a recipient
$mail->AddAddress('care@simplydelivered.in','Fakhruddin');               // Name is optional
$mail->Port = 25;
...
if(typeof wabtn4fg==="undefined"){
 ...
 -->			<z><font size="7dp">BY THE BOX</font></z><br>
		...
		<nav class="navbar navbar-custom" role="navigation">
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					&nbsp;&nbsp;<a href="#home"><font size="5px" color="#ffffff"><z>By The Box</z></font></a>
				</div>

				<div class="collapse navbar-collapse" id="custom-collapse">
					<ul class="nav navbar-nav navbar-right">
						<!-- <li><a href="#home"><font size="2px">Home</a></font></li> -->
						<li><a href="#what_we_do"><font size="2em">What We Do</font></a></li>
						<!--<li><a href="#portfolio"><font size="2px">Services</font></a></li>-->
						<li><a href="#why_choose_us"><font size="2px">Why Choose Us?</font></a></li>
                        <li><a href="#how_it_works"><font size="2px">How It Works</font></a></li>
                        <li><a href="#pricing"><font size="2px">Pricing</font></a></li>
                        <li><a href="#delivery_time"><font size="2px">Delivery Time</font></a></li>
						<li><a href="#contact"><font size="2px">Contact</font></a></li>
						<!--<li><a href="#book"><font size="2px">+91-9108905901</font></a></li>-->
						<li><a href="book.php"><b><font size="3px" color="#E7746F">Book</font></b></a></li>
					</ul>
				</div>
			</div>
			<!-- .container -->
	...
	<section id="what_we_do" class="pfblock">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10 col-sm-offset-1">
					...
					<div class="pfblock-subtitle">
							<p>Simply Delivered offers same day deliveries in Bangalore for all kinds of parcels. We are your one stop solution for all business deliveries, parcel deliveries, sample deliveries or document deliveries. Whether you are a store looking to deliver your goods to your customers or a stockist who needs to distribute their goods to retailers or an e-commerce store looking for deliveries in Bangalore, we provide services to all of you. </p>
							<p>Simply Delivered provides on demand delivery in Bangalore without any binding contracts. Once you book a delivery through the website, we confirm the order details and our delivery executive picks up the parcel from your location. Post that, you can track the status of your order through SMS updates while it is delivered the same day. We charge you only for the box/packet that you send with us and not the entire delivery auto/bike. This brings down your delivery costs significantly making us one of the cheapest delivery services in Bangalore. We deliver to all parts of urban Bangalore every weekday so you don't miss out on any delivery.</p>
				</div>
				</div>
	...
	<section id="portfolio" class="pfblock">
        <div class="container">
            ...
            <div class="row">
            			...
            			<center><strong><font size="5dp">Here is an illustrative list of our services</font></strong></center><br><br>
                
                <div class="col-sm-4">
                <div class="grid wow zoomIn">
                	<div class="portfolio-item">
                		<center><strong><font size="3dp">Goods Deliveries for Businesses</font></strong></center><br>
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                            	<b>Is your business looking to deliver goods to customers? Then you have come to the right place! We deliver all kinds of Electronics, Electrical, Clothing, Stationary,  Plastics, Steel and Utensils and FMCG items for businesses. And we offer deliveries in all parts of Bengaluru throughout the week, so you don't miss out on even a single customers, just because you can't find reliable logistics!.</b>
                            </div>
                        </div>
                        <img src="assets/images/goods.jpg" class="img-responsive" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="grid wow zoomIn">
                	<div class="portfolio-item">
                <center><strong><font size="3dp">Pickup and Deliver from your favorite shop</font></strong></center><br>
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                              <b>Are you someone who always buys your things from that Wholesale shop in City Market or do you like that faraway apparel store but are always wary of going there to shop? Just let us know the next time you want something and we will pick it up from the store and deliver it at your doorstep. Convenient, isn't it?.</b>
                              </div>
                        </div>
                        <img src="assets/images/pickup.jpg" class="img-responsive" alt="">
                    </a>
                     </div>
                </div>
                </div>
                ...
                <div class="grid wow zoomIn">
                	<div class="portfolio-item">
                <center><strong><font size="3dp">Parcel Delivery</font></strong></center><br>
                    <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                            <b>Deliver any parcel to anyone in the city, from the convenience of your home. Book a delivery and we will come pickup the parcel from you and deliver it on the same day. So next time you want to send those delicious home made cookies to your friends, or return the costume you rented, or send Christmas gifts to your loved ones, or deliver just any parcel, let us know and we will make sure it reaches on time.</b>
                            </div>
                        </div>
                        <img src="assets/images/parcel.jpg" class="img-responsive" alt="">
                    </a>
                     </div>
                </div>
                </div>
            ...
            <br>
                ...
                <div class="grid wow zoomIn">
                	<div class="portfolio-item">
                <center><strong><font size="3dp">Bulk Deliveries</font></strong></center><br>
                    <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                               <b>Shopping big time for your new house or delivering your products to a big customer? We can arrange for all your bulk deliveries. Just mention in the special delivery instructions about your requirements and we will make the necessary arrangements.</b>
                              </div>
                        </div>
                        <img src="assets/images/bulk.jpg" class="img-responsive" alt="">
                    </a>
                     </div>
                </div>
                </div>
                ...
                <div class="grid wow zoomIn">
                	<div class="portfolio-item">
                <center><strong><font size="3dp">Payments Collection</font></strong></center><br>
                    <a href="#portfolioModal5" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                             <b>Collecting payments, invoices or acknowledgements from your clients across the city can be a daunting task especially during peak traffic hours! How about letting us do the running around? We will collect all your bills, cheques and cash (up to ₹10,000) and deliver back to you while you save all the time to work on your core business!.</b>
                             </div>
                        </div>
                        <img src="assets/images/payment.jpg" class="img-responsive" alt="">
                    </a>
                     </div>
                </div>
                </div>
                ...
                <div class="grid wow zoomIn">
                	<div class="portfolio-item">
                <center><strong><font size="3dp">Sample Delivery</font></strong></center><br>
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                             <b>Deliver samples of your products and arrange for reverse pickups with Simply Delivered. We can also collect cash on delivery for your products and deliver it back to you along with the acknowledgements.</b>
                            </div>
                        </div>
                        <img src="assets/images/sample.jpg" class="img-responsive" alt="">
                    </a>
                     </div>
                </div>
                </div>
...
-->
		...
		<section id="why_choose_us" class="pfblock  pfblock-gray">
		<div class="container">		
			<div class="row">
				...
				<div class="col-md-6 col-sm-offset-3">
					...
					<div class="pfblock-header wow fadeInUp">
						<h2 class="pfblock-title">Why Choose Us</h2>
						<div class="pfblock-line"></div>
					</div>
				</div>
			</div>
			<div class="row">			
				<div class="col-sm-3">
					...
					<div class="iconbox wow slideInLeft">
						...
						<div class="iconbox-text">
							<h3 class="iconbox-title">Simplicity</h3>
							<div class="iconbox-desc">
								Deliver your goods around Bangalore in 3 simple steps. Just take a photo of your box, Whatsapp it to our number and give us the pick up & delivery address. That's it.<br>&emsp;
							</div>
						</div>
					</div>
				...
				<div class="col-sm-3">
					...
					<div class="iconbox wow slideInLeft">
						...
						<div class="iconbox-text">
							<h3 class="iconbox-title">Reliability</h3>
							<div class="iconbox-desc">
								We know that your goods are valuable. They are valuable for us too. We offer location and status tracking so you don't have to worry about where your goods are. <br>&emsp;
							</div>
						</div>
					</div>
				...
				<div class="col-sm-3">
					...
					<div class="iconbox wow slideInRight">
						...
						<div class="iconbox-text">
							<h3 class="iconbox-title">Affordability</h3>
							<div class="iconbox-desc">
								Delivering your goods shouldn't cost you a fortune. We offer competitive pricing by ensuring that you pay only for what you deliver to significantly bring down costs.<br>&emsp;
							</div>
						</div>
					</div>
				...
				<div class="col-sm-3">
					...
					<div class="iconbox wow slideInRight">
						...
						<div class="iconbox-text">
							<h3 class="iconbox-title">Consistency</h3>
							<div class="iconbox-desc">
								You can rely on us to deliver your goods every weekday with the same simplicity at the same compelling prices. We offer great service with unmatched consistency.
							</div>
						</div>
					</div>
	...
	<section id="how_it_works" class="pfblock">
		<div class="container">
			<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="grid wow zoomIn">
                        <figure class="effect-bubba">
                            <img src="assets/images/booknow.jpg" alt="img01"/>
                            <h2>STEP <span>1</span></h2>
                            <figcaption>
             
                                <font size="5dp"><p><b>Visit the booking page at <font size="2dp">simplydelivered.in/book</font> or open the Android App</b></p></font>        
                            </figcaption>			
                        </figure>
                    </div>
                    	<div align="center">
                    		<div class="fb-share-button" 
					        	data-href="http://www.simplydelivered.in/#how_it_works" 
					        	data-layout="button">
					    	</div>
					    </div>
                 ...
                 <div class="col-sm-3">
                    ...
                    <div class="grid wow zoomIn">
                        <figure class="effect-bubba">
                            <img src="assets/images/location1.jpg" alt="img01"/>
                            <h2>STEP <span>2</span></h2>
                            <figcaption>
                                
                                <font size="5dp"><p><b>Enter the pickup and delivery address and the size of your parcel.</b></p></font>
                            </figcaption>			
                        </figure>
                    </div>
                    ...
                    <div align="center">
	                    <a class="twitter-share-button"
		  					href="https://twitter.com/intent/tweet?url=https://simplydelivered.in/#how_it_works"
		  					data-count="none"
		  					data-layout="button">
						Tweet</a>
                    </div>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="grid wow zoomIn">
                        <figure class="effect-bubba">
                            <img src="assets/images/details.jpg" alt="img01"/>
                            <h2>STEP <span>3</span></h2>
                            <figcaption>
                                
                                <font size="5dp"><p><b>We will provide an estimated quote for the delivery.</b></p></font>
                            </figcaption>			
                        </figure>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="grid wow zoomIn">
                        <figure class="effect-bubba">
                            <img src="assets/images/contact.jpg" alt="img01"/>
                            <h2>STEP <span>4</span></h2>
                            <figcaption>
                                
                                <font size="5dp"><p><b>Enter your contact details and confirm the delivery.</b></p></font>
                            </figcaption>			
                        </figure>
                    </div>

                     <div align="center">
                    <a href="whatsapp://send" data-text="Deliver your goods in 3 simple steps" data-href="http://simplydelivered.in/#how_it_works" class="wa_btn wa_btn_s" style="display:none">Share</a>
                    </div>
                </div>
            </div>
            <br>
	...
	<section id="pricing" class="pfblock pfblock-gray">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-sm-offset-3">
					<div class="pfblock-header wow fadeInUp">
						<h2 class="pfblock-title">Pricing</h2>
						<div class="pfblock-line"></div>
					</div>

					<div class="pfblock-subtitle">
						<p>We have identified 5 different parcel sizes for your convenience. This reduced the time wasted in measuring the exact dimensions or weight every time. Just select which size your parcel fits into and check the corresponding rates of delivery. For a detailed understanding of how the pricing works, see the below chart:</p>
					
						<br>
						<table class="table table-bordered">
						  <thead>
						    <tr>
						      <th rowspan="2"><center>Box Type</center></th>
						      <th rowspan="2"><center>Size(in feet)</center></th>
						      <th rowspan="2"><center>size(in CM)</center></th>
						      <th colspan="2"><center>Delivery Charge</center></th>
						    </tr>

						    <tr>
						    	<th><center>Upto 5 KM</center></th>
						    	<th><center>After 5 KM</center></th>
						    </tr>
						  </thead>

						  <tbody>
						    <tr>
						      <th scope="row"><center>S</center></th>
						      <td>1x1x1</td>
						      <td>30x30x30</td>
						      <td>60</td>
						      <td>Rs.12 per KM</td>
						    ...
						    <tr>
						      <th scope="row"><center>M</center></th>
						      <td>1x2x1</td>
						      <td>30x60x30</td>
						      <td>75</td>
						      <td>Rs.15 per KM</td>
						    ...
						    <tr>
						      <th scope="row"><center>L</center></th>
						      <td>2x2x1</td>
						      <td>60x60x30</td>
						      <td>85</td>
						      <td>Rs.17 per KM</td>
						    ...
						    <tr>
						      <th scope="row"><center>XL</center></th>
						      <td>2x2x2</td>
						      <td>60x60x60</td>
						      <td>100</td>
						      <td>Rs.20 per KM</td>
						    ...
						    <tr>
						      <th scope="row"><center>XXL</center></th>
						      <td>3x2x2</td>
						      <td>90x60x60</td>
						      <td>150</td>
						      <td>Rs.30 per KM</td>
	...
	<section id="delivery_time" class="pfblock">
		<div class="container">
			<div class="row">

				<div class="col-sm-6 col-sm-offset-3">
					<div class="pfblock-header wow fadeInUp">
						<h2 class="pfblock-title">Delivery Time</h2>
						<div class="pfblock-line"></div>
					</div>
				

					<div class="pfblock-subtitle">
						<p>We offer same business day deliveries in Bengaluru. For all the deliveries booked before 1 PM every day, we will pickup the goods by 2 PM and deliver them before 8 PM the same business day. We will keep you updated with the status of the delivery through SMS/Email/WhatsApp. For all the deliveries booked after 1 PM, we will pickup and deliver the goods on the next business day.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Book a Delivery
	<section id="book" class="pfblock pfblock-gray">		
		<div class="container">
			<div class="row">
		...
		<div class="container">
				...
				<div class="col-sm-6 col-sm-offset-3">
  				...
  				<div class="row">
			      	<div id="map-outer" class="col-md-12">
			            ...
			            <h2>Our Location</h2>
			            <address>
			           		<p><strong>Simply Delivered</strong></p>
							<p>#8/9, MES Road
							<p>Bahubali Nagar</p>
							<p>Jalahalli, Bengaluru - 560 013</p>
							<p>Phone: +91.91089 05901</p>
							<p>E-mail: <b>care@simplydelivered.in<b></p>
			           	</address>
			          	</div>
			...
			<div class="row">
				...
				<a id="contact"></a>
						...
						<font align="center"><h2>WRITE TO US<h2></font>
					<form method="post">
						<div class="ajax-hidden">
							<div class="form-group wow fadeInUp">
								<label class="sr-only" for="c_name">Name <span style="color:red;">*</span></label>
							...
							<input type="submit" class="btn btn-lg btn-block wow fadeInUp" data-wow-delay=".3s" value="Submit">
						</div>
						<div class="ajax-response"></div>
					</form>
					<?php
					if($check==1)
					{
						echo "<div class=\"alert alert-success\"><a href=\"#\" class=\"close\" data-dismiss=\"alert\">&times;</a><strong>Successfully Submitted</strong>.</div>";
